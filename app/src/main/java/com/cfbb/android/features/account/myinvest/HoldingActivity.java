...
public class HoldingActivity extends BaseActivity {
    ...
    private TextView tv_currentYield;
    ...
    public void setUpViews() {
        ...
        tv_currentYield = (TextView) findViewById(R.id.tv_02);
        tv_arrreadyGetIntrested = (TextView) findViewById(R.id.tv_10);
        tv_back = (TextView) findViewById(R.id.tv_back);
        tv_back.setText(getResources().getString(R.string.my_invest_str));
        tv_title = (TextView) findViewById(R.id.tv_title);
        tv_title.setText(getResources().getString(R.string.holding));
    ...
    public void getDataOnCreate() {
        ...
        addSubscription(RetrofitClient.GetMyInvestDeatils(null, MyInvestStateEnum.HOLDING.getValue() + "", invest_id, this, new YCNetSubscriber<MyInvestDetailsBean>(this) {
    ...
    private void FillView() {
        ...
        tv_finishDate.setText(myInvestDetailsBean.buyTime);
        tv_investTotalMoney.setText(myInvestDetailsBean.totalInvestMoeny);
        tv_arrreadyGetIntrested.setText(myInvestDetailsBean.interestReceivable + Const.YUAN_STR);
        tv_currentYield.setText(myInvestDetailsBean.currentYield);
    }
