package com.cfbb.android.features.update;
...
import com.cfbb.android.protocol.downRequest.RequestResponseListener;
import com.cfbb.android.protocol.downRequest.YCDownRequest;
...
public class UpdateAppService extends Service {
    ...
    private String APK_dir =
             Environment.getExternalStorageDirectory()
                    .getAbsolutePath() + "/com.cfbb.android/download/";// 保存到SD卡路径下;
    /***
     * 下载的apk名称
     */
    ...
    private RequestResponseListener progressResponseListener = new RequestResponseListener() {
        ...
        public void onStart() {
            ...
            builder.setSmallIcon(R.mipmap.icon_tu);
        ...
        public void onRequestFailed(Exception e) {
           ...
           // builder.setDeleteIntent(PendingIntent.getBroadcast(UpdateAppService.this, NotificationID, new Intent("com.cfbb.android.NotificationClearReceive"), 0));
            mNotificationManager.notify(NotificationID,
                    builder.build());
            stopSelf();
    ...
    private void DownFile(String downUrl) {
        ...
        APK_name = UUID.randomUUID() + Const.APK_SUFFIXS_STR;
