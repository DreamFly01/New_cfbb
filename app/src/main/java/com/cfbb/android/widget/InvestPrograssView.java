 ...
 */
public class InvestPrograssView extends View{
  ...
  //  private static final int[] SECTION_COLORS = {Color.GREEN,Color.YELLOW,Color.RED};
    ...
    public InvestPrograssView(Context context, AttributeSet attrs,
                              int defStyleAttr) {
    ...
    public InvestPrograssView(Context context) {
        super(context);
        initView(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int round = mHeight/2;
        mPaint.setColor(getResources().getColor(R.color.txt_gray5));
