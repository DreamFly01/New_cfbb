...
public class MyInvestProgress extends View{
    ...
    public MyInvestProgress(Context context){
        this(context, null);
    }
    public MyInvestProgress(Context context,AttributeSet attrs){
    ...
    public MyInvestProgress(Context context, AttributeSet attrs,
        ...
        TypedArray typedArray  = context.obtainStyledAttributes(attrs, R.styleable.MyInvestProgress);
        textColor  =typedArray.getColor(R.styleable.MyInvestProgress_textColor, Color.RED);
        textSize = typedArray.getDimension(R.styleable.MyInvestProgress_textSize, 15);
        max = typedArray.getInteger(R.styleable.MyInvestProgress_max, 100);
        isDisplayText  =typedArray.getBoolean(R.styleable.MyInvestProgress_textIsDisplayable, true);
        typedArray.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 绘制底部背景图
        bmpTemp = Utils.decodeCustomRes(getContext(), R.mipmap.arc_bg);
        ...
        bmpTemp = Utils.decodeCustomRes(getContext(), R.mipmap.arc_progress);
