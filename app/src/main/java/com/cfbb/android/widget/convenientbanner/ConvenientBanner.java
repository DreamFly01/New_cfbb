package com.cfbb.android.widget.convenientbanner;
...
import com.cfbb.android.widget.convenientbanner.adapter.CBPageAdapter;
import com.cfbb.android.widget.convenientbanner.holder.CBViewHolderCreator;
import com.cfbb.android.widget.convenientbanner.listener.CBPageChangeListener;
import com.cfbb.android.widget.convenientbanner.listener.OnItemClickListener;
import com.cfbb.android.widget.convenientbanner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            pointView.setLayoutParams(new LayoutParams((int)getContext().getResources().getDimension(R.dimen.point_roundWidth), (int)getContext().getResources().getDimension(R.dimen.point_roundWidth)));
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (xMoved) {
                    if (pullDownView != null) {
                        pullDownView.setIsEnable(false);
                    }
                }
                break;
            case MotionEvent.ACTION_UP:
                if (pullDownView != null) {
                    pullDownView.setIsEnable(true);
                }
                break;
